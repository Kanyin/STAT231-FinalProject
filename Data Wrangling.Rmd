...
dataFinal <- data %>%
  ...
  mutate('Total Rounds' = as.numeric('Total Rounds'),
         ...
         'Total Distance(ft) Prox to Hole' = as.numeric('Total Distance(ft) Prox to Hole'),
         
         #Creating our desired variables
         
         'Cut Made' = ifelse('Finish Position(numeric)' < 999, 1, 0),
         ...
         'Avg. Proximity to Hole (All)' = 'Total Distance(ft) Prox to Hole' / 'Total Holes Played',
