...
The most important single predictor in our random forest was average number of greens in regulation per round. In our random forest, trends in the average greens in regulation hit by players was the most useful predictor variable in explaining whether or not a player made the cut. This matches what we saw in our exploratory data analysis where there were clear differences in the distrubutions of cut and not-cut players in terms of their average greens in regulation per round. Players who are looking to make the cut in an event should focus on hitting as many greens in regulation as possible to maximize their chances of making the cut.
